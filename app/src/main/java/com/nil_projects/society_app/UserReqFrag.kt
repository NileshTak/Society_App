...
class UserReqFrag : Fragment() {
   ...
   // internal var mViewPager: MaterialViewPager? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        adapter.addFragment(RecyclerViewFragment() , "Pending Requests");
        adapter.addFragment(AcceptedFragment(), "Accepted Requests");
        adapter.addFragment(RejectedFragment(), "Rejected Requests");
